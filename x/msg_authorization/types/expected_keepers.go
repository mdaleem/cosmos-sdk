...
type Keeper interface {
	...
	Grant(ctx sdk.Context, grantee sdk.AccAddress, granter sdk.AccAddress, authorization AuthorizationI, expiration time.Time)
	...
	GetAuthorization(ctx sdk.Context, grantee sdk.AccAddress, granter sdk.AccAddress, msgType sdk.Msg) (cap AuthorizationI, expiration time.Time)
}

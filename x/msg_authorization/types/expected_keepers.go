...
type Keeper interface {
	...
	Grant(ctx sdk.Context, grantee sdk.AccAddress, granter sdk.AccAddress, authorization CapabilityI, expiration time.Time)
	...
	GetAuthorization(ctx sdk.Context, grantee sdk.AccAddress, granter sdk.AccAddress, msgType sdk.Msg) (cap CapabilityI, expiration time.Time)
}
